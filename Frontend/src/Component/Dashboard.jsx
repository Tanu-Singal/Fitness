    ...
    const fetchCalories = async () => {
      try {
        const response = await fetch(
          `https://fitness-app-backend5.onrender.com/api/calorie/user/${userId}?range=${viewMode}`
        );
 ...
 useEffect(() => {
    const fetchWorkoutDays = async () => {
      try {
        ...
        const res = await fetch(`https://fitness-app-backend5.onrender.com/api/user/${userId}`); // Replace USER_ID with actual user ID or fetch from auth
